...
//|                                                                  |
//+------------------------------------------------------------------+
class TextClass : public CommonObjectClass
  {
protected:
...
public:
   ...
   TextClass *NewObject()
     {
      TextClass *newObject=new TextClass(ModuleName,chartId);
      newObject.isIndividual=true;

      return newObject;
     }
                     TextClass(string _parentName,long _chartId): CommonObjectClass(_parentName,_chartId)
     {

     };

   TextClass *Create(datetime time=0,// anchor point time
